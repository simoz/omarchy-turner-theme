...
The distributed JPEG wallpapers have a maximum long edge of 5120 pixels, with no upscaling or artistic color adjustments. JPEGs are losslessly optimized where this reduces file size; decoded pixels remain unchanged. Original aspect ratios are preserved to pixel rounding. Snow Storm has a centered trim of approximately 1% per edge to remove the dark outer border. Images already below the size limit are kept unchanged when recompression would increase their file size. The wallpapers total approximately 30.5 MiB; the 1280-pixel previews total approximately 2.0 MiB.
...
![Inverary Pier, Loch Fyne: Morning](previews/03-inverary-pier.jpg)
...
![Staffa, Fingal’s Cave](previews/04-staffa-fingals-cave.jpg)
...
![The Dogana and Santa Maria della Salute, Venice](previews/05-dogana-santa-maria-della-salute.jpg)
...
![Keelmen Heaving in Coals by Moonlight](previews/06-keelmen-by-moonlight.jpg)
...
![Dort or Dordrecht: The Dort Packet-Boat from Rotterdam Becalmed](previews/07-dort-or-dordrecht.jpg)
...
![Wreckers – Coast of Northumberland, with a Steam-Boat Assisting a Ship off Shore](previews/08-wreckers-northumberland.jpg)
...
![The Fighting Temeraire](previews/09-the-fighting-temeraire.jpg)
